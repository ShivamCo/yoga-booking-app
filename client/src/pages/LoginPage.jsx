...
const LoginPage = () => {
    ...
    const submitHandler = async (event) => {
        ...
        try {
            ...
            const userData = await axios.post('http://localhost:5000/api/login', userDetails)
            ...
            <div className="lg:p-36 md:p-52  sm:20 p-8 w-full lg:w-1/2">
                ...
                <form onSubmit={submitHandler} >
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" required name="email" onChange={onChangeHandler} className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autoComplete="off" />
                    </div>

                    <div className="mb-4">
                        <label className="block text-gray-600">Password</label>
                        <div className="relative">
                            <input onChange={onChangeHandler} name="password" type={show ? "text" : "password"} required autoComplete="current-password" className='w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]' />
