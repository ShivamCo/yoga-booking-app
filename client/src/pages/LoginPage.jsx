...
const LoginPage = () => {
    ...
    const submitHandler = async (event) => {
        ...
        try {
            setIsLoading(true)
            const userData = await axios.post('https://yoga-booking-app-p551.onrender.com/api/login', userDetails)
            ...
            <div className="lg:p-36 md:p-52  sm:20 p-8 w-full lg:w-1/2">
                ...
                <form onSubmit={submitHandler} >
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" value={userDetails.email} required name="email" onChange={onChangeHandler} className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autoComplete="off" />
                    </div>

                    <div className="mb-4">
                        <label className="block text-gray-600">Password</label>
                        <div className="relative">
                            <input value={userDetails.password} onChange={onChangeHandler} name="password" type={show ? "text" : "password"} required autoComplete="current-password" className='w-full rounded-md py-2.5 px-4 border text-sm outline-[#f84525]' />

                            <div className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                                <button onClick={() => setShow(!show)} type="button" id="togglePassword" className="text-gray-500 focus:outline-none focus:text-gray-600 hover:text-gray-600">
                    ...
                    <span className="justify-center items-center flex flex-col text-gray-500  pt-4 px-4" >
