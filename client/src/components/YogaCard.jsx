        ...
        <div className="w-full h-fit max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-2 divide-y divide-dashed pb-2">
                ...
                <div className="flex py-1 items-center justify-between">
                    ...
                    <button onClick={handleJoinNow} value={classData.classID} className="text-white bg-gradient-to-r from-green-400 to-green-500 hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 sm:px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Join Now</button>
                </div>
            </div>
        </div>
